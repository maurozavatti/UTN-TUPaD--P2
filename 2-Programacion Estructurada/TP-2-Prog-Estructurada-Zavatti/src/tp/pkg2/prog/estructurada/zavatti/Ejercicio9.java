...
public class Ejercicio9 {
    public static void main(String[] args) {
        ...
        // Llamamos al metodo para calcular costo de envio y guardamos el retorno en una variable
        double costoEnvio = calcularCostoEnvio(peso, zona);
        
        // Llamamos al metodo para calcular el precio total de la compra y guardamos el retorno en una variable
